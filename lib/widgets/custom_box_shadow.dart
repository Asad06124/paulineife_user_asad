...
TextStyle normal_h5Style_bold =
    TextStyle(color: appTextColor, fontSize: 8.sp, fontWeight: FontWeight.bold);
TextStyle normal_h6Style_bold =
    TextStyle(color: appTextColor, fontSize: 6.sp, fontWeight: FontWeight.bold);
...
TextStyle grey_h1Style_bold =
    TextStyle(color: opacityGrey, fontSize: 16.sp, fontWeight: FontWeight.bold);
TextStyle grey_h2Style_bold =
    TextStyle(color: opacityGrey, fontSize: 14.sp, fontWeight: FontWeight.bold);
TextStyle grey_h3Style_bold =
    TextStyle(color: opacityGrey, fontSize: 12.sp, fontWeight: FontWeight.bold);

TextStyle heading1_style_web =
    TextStyle(fontSize: (26 + 2), fontWeight: FontWeight.bold);
TextStyle heading2_style_web =
    TextStyle(fontSize: (23 + 2), fontWeight: FontWeight.bold);
TextStyle heading3_style_web =
    TextStyle(fontSize: (19 + 2), fontWeight: FontWeight.bold);
TextStyle heading4_style_web =
    TextStyle(fontSize: (16 + 2), fontWeight: FontWeight.bold);

TextStyle normal_h1Style_web =
    TextStyle(color: appTextColor, fontSize: (2 + 16));
TextStyle normal_h2Style_web =
    TextStyle(color: appTextColor, fontSize: (2 + 14));
TextStyle normal_h3Style_web =
    TextStyle(color: appTextColor, fontSize: (2 + 12));
TextStyle normal_h4Style_web =
    TextStyle(color: appTextColor, fontSize: (2 + 10));
TextStyle normal_h5Style_web =
    TextStyle(color: appTextColor, fontSize: (2 + 8));
TextStyle normal_h6Style_web =
    TextStyle(color: appTextColor, fontSize: (2 + 6));

TextStyle normal_h1Style_bold_web = TextStyle(
    color: appTextColor, fontSize: (16 + 2), fontWeight: FontWeight.bold);
TextStyle normal_h2Style_bold_web = TextStyle(
    color: appTextColor, fontSize: (14 + 2), fontWeight: FontWeight.bold);
TextStyle normal_h3Style_bold_web = TextStyle(
    color: appTextColor, fontSize: (12 + 2), fontWeight: FontWeight.bold);
TextStyle normal_h4Style_bold_web = TextStyle(
    color: appTextColor, fontSize: (10 + 2), fontWeight: FontWeight.bold);
TextStyle normal_h5Style_bold_web = TextStyle(
    color: appTextColor, fontSize: (8 + 2), fontWeight: FontWeight.bold);
TextStyle normal_h6Style_bold_web = TextStyle(
    color: appTextColor, fontSize: (6 + 2), fontWeight: FontWeight.bold);
...
TextStyle grey_h1Style_bold_web = TextStyle(
    color: opacityGrey, fontSize: (16 + 2), fontWeight: FontWeight.bold);
TextStyle grey_h2Style_bold_web = TextStyle(
    color: opacityGrey, fontSize: (14 + 2), fontWeight: FontWeight.bold);
TextStyle grey_h3Style_bold_web = TextStyle(
    color: opacityGrey, fontSize: (12 + 2), fontWeight: FontWeight.bold);
