                ...
                children: [
                  ...
                  Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        ).marginOnly(left:8.sp,top: 5.sp),
                        Form(
                          key: formKey,
                          child: IntlPhoneField(
                            validator: (value) {
                              if (value!.completeNumber.isBool) {
                            ...
                            initialCountryCode: otpController.countryCode.value,
                            dropdownIconPosition: IconPosition.trailing,
                            flagsButtonPadding: EdgeInsets.only(left: 6 .sp,),
                            dropdownIcon: Icon(
                              Icons.arrow_drop_down,
                              color: Colors.black,
                            ),
                            onCountryChanged: (value){
                              otpController.countryCode.value=value.dialCode;

                            },
                            onChanged: (value) {
                              apiController.phoneController.value.text =value.number;
                            },
                   ...
                   //
                   // }, child: Text("${otpController.countryCode.value}/${otpController.phoneController.value.text}/${apiController.phoneController.value.text}")),
                  // SizedBox(
                  //   height: 10.sp,
                  // ),
                  ...
                  Form(
                    ...
                    child: Pinput(
                      ...
                      //   height: 1,
                      // ),
                    ).marginSymmetric(horizontal: 10.w,vertical: 10.sp),
                  ),
                  // SizedBox(
                  //   height: 1.h,
                  // ),
