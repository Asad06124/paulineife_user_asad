                          ...
                          ? GestureDetector(
                              ...
                              child: Builder(builder: (_) {
                                ...
                                if (controller.posts.value.isNotEmpty &&
                                    controller.posts.value.first != null &&
                                    controller.posts.value.first.image is ImageProvider) {
                                  imageProvider = controller.posts.value.first.image as ImageProvider<Object>?;
                                } else {
